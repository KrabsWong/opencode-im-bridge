...
const { markdownToEntities, splitEntities } = require('./bridge-hub/dist/core/markdown-entities.js');
...
// Test 2: Simulate entitiesToMarkdown
...
// Test 3: With splitting
console.log('=== Test 3: With message splitting ===');
...
console.log('\n\n=== Test 4: Inline code ===');
const markdown4 = 'Use the `console.log()` function to print output.';
